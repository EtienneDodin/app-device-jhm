<x-app-layout>
    ...
    <form action="{{ route('locations.update', $location) }}" method="POST" class="font-proxima flex flex-col items-center gap-8">
        @method('PUT')
        @csrf
        ...
        <div class="flex flex-col gap-2 items-center">
            ...
            <input type="text" name="name" id="name" value="{{ $location->name }}" class="w-56 border rounded-md border-anthracite-grey">
        </div>
