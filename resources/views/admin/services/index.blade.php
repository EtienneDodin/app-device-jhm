<x-app-layout>
    ...
    <div class="flex flex-col items-center">
        ...
        <a href="{{ route('services.create') }}" class="group mt-4 mb-16 py-1.5 px-4 flex gap-2 items-center bg-white hover:bg-light-gray transition duration-200 ease-in-out border rounded-md border-main-gray">
        ...
        <div>
            <div class="bg-light-gray font-proxima flex gap-16 items-center">
                <h1 class="text-lg pl-4 pr-28 py-4">Liste des services</h1>
            </div>
            ...
            <div class="flex relative py-1 items-center border-b">
                ...
                <div class="absolute -right-44 flex gap-6 items-center">
                    ...
                    <form action="{{ route('services.destroy', $service) }}" method="POST" x-data="{ open: false }">
                        @method('DELETE')
                        @csrf
                        <button type="button" @click="open = true" class="rounded-md px-3 py-1.5 border decoration-main-gray text-gray-500 text-sm hover:bg-light-orange">
