<x-app-layout>
    ...
    <div class="flex flex-col items-center">
        ...
        <a href="{{ route('types.create') }}" class="group mt-4 mb-16 py-1.5 px-4 flex gap-2 items-center bg-white hover:bg-light-gray transition duration-200 ease-in-out border rounded-md border-main-gray">
                        ...
                        <form action="{{ route('types.destroy', $type) }}" method="POST" x-data="{ open: false }">
                            ...
                            <div x-show="open" x-transition x-cloak class="fixed left-0 top-0 w-full h-screen z-10 flex justify-center items-center">
                                ...
                                <div @click.outside="open = false" class="bg-main-gray flex flex-col p-24 items-center gap-24 rounded border shadow z-10 w-6/12">
                                    <p class="font-semibold text-3xl">Êtes-vous sûr de vouloir supprimer cet utilisateur ?</p>
