<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex flex-col items-center">
            {{-- Add new owner --}}
            <a href="{{ route('owners.create') }}" class="mt-4 mb-16 py-1.5 px-4 flex gap-2 items-center bg-white hover:bg-light-gray transition duration-200 ease-in-out border rounded-md border-main-gray">
