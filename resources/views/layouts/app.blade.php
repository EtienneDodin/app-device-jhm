    ...
    <div class="min-h-screen flex">
        ...
        <header class="w-[4%] min-w-12 flex justify-center">
            ...
            <nav class="fixed inset-y-1/4 py-4 h-screen">
                ...
                <ul class="flex flex-col items-center gap-8 relative px-2">
                    {{-- Index --}}
                    ...
                    {{-- Admin panel --}}
                    <li class="hover:-translate-y-2 absolute -bottom-[5.6rem] transition duration-150 ease-in-out">
        ...
        <main class="w-[96%]">
            <div>
                <div class="flex justify-center">
                    ...
                    {{-- Heading --}}
                    <div class="mb-4 flex flex-col w-8xl">
                        {{-- Title and logo --}}
                        <div class="flex gap-80 items-center justify-center pt-10 pb-9">
                            <h1 class="font-akazan text-5xl text-main-blue">{{ $header }}</h1>
                        ...
                        <div class="flex gap-2 text-gray-700">
                            ...
                            @if (request()->routeIs('services.edit'))
                                <a href="{{ route('index') }}" class="underline underline-offset-2 decoration-slate-300">Accueil</a>
                                <span>/</span>
                                <a href="{{ route('services.index') }}" class="underline underline-offset-2 decoration-slate-300">Gestion des services</a>
                                <span>/</span>
